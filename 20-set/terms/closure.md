...
**A set has closure under some operation** if performance of that operation on members of the set always produces a member of that same set. In this case we also say that the **set is closed under that operation**.
