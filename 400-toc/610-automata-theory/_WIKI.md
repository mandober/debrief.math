...
- [Alternating finite automaton](https://en.wikipedia.org/wiki/Alternating_finite_automaton)
- [Aperiodic finite state automaton](https://en.wikipedia.org/wiki/Aperiodic_finite_state_automaton)
...
- [Co-Büchi automaton](https://en.wikipedia.org/wiki/Co-B%C3%BCchi_automaton)
...
- [Finite state machine with datapath](https://en.wikipedia.org/wiki/Finite_state_machine_with_datapath)
...
- [Foma (software)](https://en.wikipedia.org/wiki/Foma_(software))
- [Generalized nondeterministic finite automaton](https://en.wikipedia.org/wiki/Generalized_nondeterministic_finite_automaton)
- [Glushkov's construction algorithm](https://en.wikipedia.org/wiki/Glushkov%27s_construction_algorithm)
- [HFST](https://en.wikipedia.org/wiki/HFST)
- [Kleene's algorithm](https://en.wikipedia.org/wiki/Kleene%27s_algorithm)
- [Krohn-Rhodes theory](https://en.wikipedia.org/wiki/Krohn%E2%80%93Rhodes_theory)
...
- [Muller automaton](https://en.wikipedia.org/wiki/Muller_automaton)
- [Myhill-Nerode theorem](https://en.wikipedia.org/wiki/Myhill%E2%80%93Nerode_theorem)
- [Nondeterministic finite automaton](https://en.wikipedia.org/wiki/Nondeterministic_finite_automaton)
- [Permutation automaton](https://en.wikipedia.org/wiki/Permutation_automaton)
- [Powerset construction](https://en.wikipedia.org/wiki/Powerset_construction)
- [Probabilistic automaton](https://en.wikipedia.org/wiki/Probabilistic_automaton)
- [Pumping lemma for regular languages](https://en.wikipedia.org/wiki/Pumping_lemma_for_regular_languages)
- [Quantum finite automata](https://en.wikipedia.org/wiki/Quantum_finite_automata)
- [Quotient automaton](https://en.wikipedia.org/wiki/Quotient_automaton)
- [RE/flex](https://en.wikipedia.org/wiki/RE/flex)
- [Regular language](https://en.wikipedia.org/wiki/Regular_language)
- [Self-verifying finite automaton](https://en.wikipedia.org/wiki/Self-verifying_finite_automaton)
- [Semiautomaton](https://en.wikipedia.org/wiki/Semiautomaton)
- [Separating words problem](https://en.wikipedia.org/wiki/Separating_words_problem)
...
- [Tree transducer](https://en.wikipedia.org/wiki/Tree_transducer)
- [Trie](https://en.wikipedia.org/wiki/Trie)
- [Tsetlin machine](https://en.wikipedia.org/wiki/Tsetlin_machine)
- [Two-way finite automaton](https://en.wikipedia.org/wiki/Two-way_finite_automaton)
- [Unambiguous finite automaton](https://en.wikipedia.org/wiki/Unambiguous_finite_automaton)
- [Union of two regular languages](https://en.wikipedia.org/wiki/Union_of_two_regular_languages)
- [Ω-automaton](https://en.wikipedia.org/wiki/%CE%A9-automaton)
