...
Algebraic structure |id |inv|tot|ass| comm |dist| ops
--------------------|---|---|---|---|------|----|--------
Commutative group   | i | r | t | a |    c |    | 1 irtac
...
Semigroupoid        |   |   |   | a |      |    | 1 ---a
                    |   |   |   |   |      |    |
Category            |   |   |   | a |      |    | 1 (func composition)
                    |   |   |   |   |      |    |
Ring                | i | r | t | a |    c | d  | 2 (ext add, ext mult)
                    |   |   |   |   |      |    |
Field               | i | r | t | a |    c | d  | 4 + - ÷ ×

(Identity, Invertibility, Totality, Associativity, Commutativity, Distributivity)
